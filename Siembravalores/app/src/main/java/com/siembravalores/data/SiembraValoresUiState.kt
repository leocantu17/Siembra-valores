package com.siembravalores.data
...
data class SiembraValoresUiState(
    ...
    val contrasenaActualizada: Boolean = false,
    val codigoVerificacion: String = "",
    val nuevaContrasena: String = "",
    val confirmarContrasena: String = "",
    var noIngresadoAntes: Boolean =false,
)

@Serializable
data class Usuario (
    val ID_US: Int,
    val FECHA_CON:String?=null,
...
@Serializable
data class CambioContrasenaResponse(
    val success: Boolean? = null,
    val message: String? = null,
    val error: String? = null
)
