    ...
    switch(tabla){
        case 'alumnos':
            columnas.push({nombre:'ID', id:'idUsu'},{nombre:'Nombre', id: 'nombreUsu'},
                          ...
                          {nombre:'Nombre de la escuela', id: 'nombreEsc'},{nombre:'Activo', id: 'estatusUsu'},{nombre:'Notificaciones', id: 'notificaciones'},{nombre:'Eliminar', id: 'eliminar'})
        break;
        case 'escuelas':
            columnas.push({nombre:'ID', id:'idEsc'},{nombre:'Nombre', id: 'nombreEsc'},
                          ...
                          {nombre:'Nombre de la colonia', id: 'nombreCol'},{nombre:'Activo', id: 'estatusEsc'},{nombre:'Eliminar', id: 'eliminar'})
        break;
        case 'colonias':
            columnas.push({nombre:'ID', id:'idCol'},{nombre:'Nombre', id: 'nombreCol'},
                          ...
                          {nombre:'Meta', id: 'meta'},{nombre:'Mínimo de arboles', id: 'minimoArboles'},{nombre:'Activo', id: 'estatusCol'},{nombre:'Eliminar', id: 'eliminar'})
        break;
        default:
            columnas.push({nombre:'ID', id:'idArbol'},{nombre:'Nombre científico', id: 'nombreCien'},
            {nombre:'Valor', id:'valor'},{nombre:'Nombre de la colonia'},{nombre:'Fecha de alta'},{nombre:'Vivo'},{nombre:'Eliminar', id: 'eliminar'},{nombre:'Reporte', id: 'reporte'})
        break
    }
